...
lazy val fragnosticI18nApiSettings = Seq(
...
lazy val fragnosticI18nApiProject = Project(
  id = "fragnostic-i18n-api-project",
  base = file(".")).settings(
    fragnosticI18nApiSettings ++ Seq(
...
lazy val fragnosticI18nApi = Project(
  id = "fragnostic-i18n-api",
  base = file("fragnostic-i18n-api")).settings(fragnosticI18nApiSettings ++ Seq(
